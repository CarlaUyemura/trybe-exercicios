...
const warriorDamage = () => Math.floor(Math.random()* (60 - 30 + 1) + 30);
...
const mageDamage = () => {
  if(mage.mana >= 15) {
  mage.damage = Math.floor(Math.random()* (90 - 45 + 1) + 45);
  mage.mana -= 15;
  return mage.damage;
...
const turnWarrior = (warriorDamage) => {
